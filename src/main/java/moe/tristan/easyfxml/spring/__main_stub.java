...
public final class __main_stub {
    ...
    private __main_stub() {
        throw new Error("Should not create such an instance.");
    }

    public static void main(final String[] args) {
        throw new UnsupportedOperationException("This is a stub so the jar can be made as it needs a main class");
    }
}

...
public interface EasyFxml {
     ...
     *
     * @param node The ement's {@link FxmlNode} counterpart. Try to avoid loading things using manual path
     ...
     *             {@link BaseEasyFxml#loadFileAsPane(String)} after sublcassing it.
     *
